...
student name, cohort name, cohort starting dates
```
...
1. **[A]cohort has many [B]students**
2. And on the other side, **[B] belongs to [A]**
3. In that case, the foreign key is in the table [B]students (cohort_id)
...
-- The foreign key name is always {other_table_singular}_id
  cohort_id int,
-- When a record is deleted we can configure the database to automatically remove related records referencing it

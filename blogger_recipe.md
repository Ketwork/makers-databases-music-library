...
posts, title, content, comments, author_name
```
...
1. **[A]post has many [B]comments**
2. And on the other side, **[B] belongs to [A]**
3. In that case, the foreign key is in the table [B]comments(post_id)
...
1. Can one artist have many posts? YES
